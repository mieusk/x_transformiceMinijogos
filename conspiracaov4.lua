...
--aleatorização
--como todo tipo de aleatorização que eu tentava fazer sempre acabava criando um padrão
--(exemplo: a cadeira 2 NUNCA era escolhida com a cadeira 3 pra serem espiões juntos, testei umas 50x e nunca foi)
--eu tive que criar essa gambiarra aqui
--pelo menos agora a impressão é de que não tem um padrão no jogo
--amém né
do
  local aleatorizar = function(numeroDeVezes)
    for _=1, numeroDeVezes do
      for i=1, math_random(8) do
        math_randomseed(math_random()+math_random((os_time()/64)+math_random()*99+math_random(99)))
      end
    end
  end
  local executarAleatorio = function(numeroDeVezes)
    for _=1, math_random(numeroDeVezes) do
      aleatorizar(numeroDeVezes)
    end
  end
  for i=1, math_random(8) do
    executarAleatorio(math_random(8))
  end
  for i=1, math_random(8) do
    executarAleatorio(math_random(i))
  end
  for i=1, math_random(8) do
    executarAleatorio(math_random(8))
  end
...
local listaDeModos = { 
  ...
  { --parte em que mostra se vc é espião ou sociedade 2
   ...
   { --exibição da missão que iniciará 3
    ...
    _modoAtual = false,
    _textAreaDeTempo = 8,
    duracaoDoModo = 15 --este número precisa de ser maior que ou igual a 7
    },
...
local _backUpModo = listaDeModos
...
local textAreas = function(numeroDaTextArea, jogadorAlvo, textoAuxiliar, numeroExtra, numeroExtra2)
  ...
  for i=numeroDaTextArea, numeroDaTextArea do
    return ({
      ...
      {20, string_format('<p align="center"><font color="#%s" size="14"><a href="event:%s">Aprovar</a></font></p>', coresPadrao.brancoDeTexto, textoAuxiliar), jogadorAlvo, 230, 340, 135, 24, numeroExtra, tonumber('0x'..coresPadrao.textAreaBorda), 1, false}, --terminar
      {21, string_format('<p align="center"><font color="#%s" size="14"><a href="event:%s">Recusar</a></font></p>', coresPadrao.brancoDeTexto, textoAuxiliar), jogadorAlvo, 435, 340, 135, 24, numeroExtra, tonumber('0x'..coresPadrao.textAreaBorda), 1, false},
      {22, textoAuxiliar, jogadorAlvo, 160, 175, 480, 240, nil, nil, 0, false}
  })[i]
  end
end
  ...
  while true do
        ...
        for i=1, #jogadoresNoJogo do
          if jogadoresNoJogo[i][1] == liderDaMissao then
              ...
              if jogadoresNoJogo[numeroEscolhido][2] == 0 and jogadoresNoJogo[k][2] == 0 then
                local escolheCor = 3
                for j=1, string_len(jogadoresNoJogo[numeroEscolhido][1]) do
                  textoColorido[#textoColorido+1] = corColorida[escolheCor].."'>"..string_sub(jogadoresNoJogo[numeroEscolhido][1], j, j).."<font color='#"
                  if escolheCor == 3 then
                    escolheCor = 1
                  else
                    escolheCor = 3
                  end
                  if j == string_len(jogadoresNoJogo[numeroEscolhido][1]) then
            ...
            carregarTextArea(14, nil, string_format('<p align="center"><b><font color="#%s" size="10">Líder</font></b></p>', coresPadrao.brancoDeTexto), i)
          else
            coresPadrao._colocar = coresPadrao.colocarPadrao
            carregarTextArea(14, jogadoresNoJogo[numeroEscolhido][1], string_format('<p align="center"><b><font color="#%s" size="9"><a href="event:selecionar">Incluir</a></font></b></p>', coresPadrao.brancoDeTexto), i)
          end
        end
      end
    ...
    if listaDeModos[5]._modoAtual then
      ...
      if listaDeModos[5]._primeiraVez then
        ...
        carregarTextArea(11, nil, string_format('<font size="16" color="#%s"><b>&#12288;&#12288;Missão #%s</b></font>\n<font size="22" color="#%s"><b>&#12288;&#12288;&#12288; <font size="16" color="#%s"><b>└ </b></font>Aprovação dos agentes</b></font>', coresPadrao.missaoNumero, _missaoAtual, coresPadrao.brancoDeTexto, coresPadrao.lider))
        for i=1, #jogadoresNoJogo do
          if jogadoresNoJogo[i][2] == 0 then
            if next(agentesDeVerdade[1]) == nil then
              carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<font size="13" color="#%s">\n\n&#12288;Decida se você aprovaria os agentes:\n\n&#12288;&#12288;&#12288;➜ %s', coresPadrao.brancoDeTexto, table_concat(agentesDeVerdade[2], '\n&#12288;&#12288;&#12288;➜ ')))
            elseif (next(agentesDeVerdade[1]) == nil) == false and (next(agentesDeVerdade[2]) == nil) == false then
              carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<font size="13" color="#%s">\n\n&#12288;Decida se você aprovaria os agentes:\n\n&#12288;&#12288;&#12288;➜ %s', coresPadrao.brancoDeTexto, table_concat(agentesDeVerdade[1], '\n&#12288;&#12288;&#12288;➜ ')..'\n&#12288;&#12288;&#12288;➜ '..table_concat(agentesDeVerdade[2], '\n&#12288;&#12288;&#12288;➜ ')))
            else
              carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<font size="13" color="#%s">\n\n&#12288;Decida se você aprovaria os agentes:\n\n&#12288;&#12288;&#12288;➜ %s', coresPadrao.brancoDeTexto, table_concat(agentesDeVerdade[1], '\n&#12288;&#12288;&#12288;➜ ')))
            end
          else
            carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<font size="13" color="#%s">\n\n&#12288;Decida se você aprovaria os agentes:\n\n&#12288;&#12288;&#12288;➜ %s', coresPadrao.brancoDeTexto, table_concat(agentesNormal, '\n&#12288;&#12288;&#12288;➜ ')))
          end
    ...
    if listaDeModos[6]._modoAtual then --modo para checar se agentes foram aprovados
      ...
      if listaDeModos[6]._primeiraVez then
        ...
        if tablelength(quemAprovou) > tablelength(quemRecusou) then
          carregarTextArea(11, nil, string_format('\n<p align="center"><font size="16" color="#%s"><b>Agentes aprovados. A missão irá começar.</b></font></p>', coresPadrao.sociedade))
          --aqui é pra mostrar 'agentes foram aprovados'
        else
          carregarTextArea(11, nil, string_format('\n<p align="center"><font size="16" color="#%s"><b>OS AGENTES FORAM RECUSADOS</b></font></p>', coresPadrao.espiao))
        ...
        for i=1, #jogadoresNoJogo do
          if jogadoresNoJogo[i][2] == 0 then
            if next(agentesDeVerdade[1]) == nil then
              carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<p align="center"><font size="14" color="#%s">\n\n✷ %s ✷', coresPadrao.brancoDeTexto, table_concat(agentesDeVerdade[2], ' ✷'..quebraDeLinha..'✷ ')))
            elseif (next(agentesDeVerdade[1]) == nil) == false and (next(agentesDeVerdade[2]) == nil) == false then
              carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<p align="center"><font size="14" color="#%s">\n\n✷ %s ✷', coresPadrao.brancoDeTexto, table_concat(agentesDeVerdade[1], ' ✷'..quebraDeLinha..'✷ ')..'\n'..table_concat(agentesDeVerdade[2], ' ✷'..quebraDeLinha..'✷ ')))
            else
              carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<p align="center"><font size="14" color="#%s">\n\n✷ %s ✷', coresPadrao.brancoDeTexto, table_concat(agentesDeVerdade[1], ' ✷'..quebraDeLinha..'✷ ')))
            end
          else
            carregarTextArea(22, jogadoresNoJogo[i][1], string_format('<p align="center"><font size="14" color="#%s">\n\n✷ %s ✷', coresPadrao.brancoDeTexto, table_concat(agentesNormal, ' ✷'..quebraDeLinha..'✷ ')))
          end
        end
      end
      ...
      elseif tempoPercorrido >= listaDeModos[6].duracaoDoModo then
        ...
        liderDaMissao = jogadoresNoJogo[numeroEscolhido][1] --coloca o líder da missão aleatoriamente
        listaDeModos[3] = _backUpModo[3]
        listaDeModos[6] = _backUpModo[6]
        listaDeModos[3]._modoAtual, listaDeModos[3]._primeiraVez = true, true
        listaDeModos[6]._modoAtual = false
        tempoPercorrido = 0
...
eventTextAreaCallback = function(numeroDaTextArea, quemClicou, nomeDoEvento)
  ...
  if numeroDaTextArea > 13 and quemClicou == jogadoresNoJogo[numeroEscolhido][1] and nomeDoEvento == 'selecionar' and listaDeModos[4]._modoAtual then
    ...
    carregarTextArea(14, jogadoresNoJogo[numeroEscolhido][1], string_format('<p align="center"><b><font color="#%s" size="9"><a href="event:remover">Retirar</a></font></b></p>', coresPadrao.brancoDeTexto), numeroDaTextArea-13)
    for i=1, #jogadoresNoJogo do
    ...
    if tablelength(agentesAtuais) > numeroDeAgentesNaMissao then
      for k, v in next, agentesAtuais do
        if v == ''  then
          ...
          carregarTextArea(14, jogadoresNoJogo[numeroEscolhido][1], string_format('<p align="center"><b><font color="#%s" size="9">\\\\\\</font></b></p>', coresPadrao.lider), tonumber(k))
        end
      end
    end
  end
  if numeroDaTextArea > 13 and quemClicou == jogadoresNoJogo[numeroEscolhido][1] and nomeDoEvento == 'remover' and listaDeModos[4]._modoAtual then
    coresPadrao._colocar = coresPadrao.colocarPadrao
    carregarTextArea(14, jogadoresNoJogo[numeroEscolhido][1], string_format('<p align="center"><b><font color="#%s" size="9"><a href="event:selecionar">Incluir</a></font></b></p>', coresPadrao.brancoDeTexto), numeroDaTextArea-13)
    for i=1, #jogadoresNoJogo do
      if jogadoresNoJogo[i][2] == 0 and jogadoresNoJogo[numeroDaTextArea-13][2] == 0 then
    ...
    for k, v in next, agentesAtuais do
      if v == '' then
        coresPadrao._colocar = coresPadrao.colocarPadrao
        carregarTextArea(14, jogadoresNoJogo[numeroEscolhido][1], string_format('<p align="center"><b><font color="#%s" size="9"><a href="event:selecionar">Incluir</a></font></b></p>', coresPadrao.brancoDeTexto), tonumber(k))
      end
    end
  end
...
local sala = {'Sklag#2552', 'Preuclides#3383', 'Helsey#6880', 'Infectsoul#2048', 'Avuhcie#0000', 'Pierreee#0846'}
